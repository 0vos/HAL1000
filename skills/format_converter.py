...
def format_converter(
    ...
    if not isinstance(text, str) or not text.strip():
        raise attach_error_code(ValueError("text must be a non-empty string"), ErrorCode.INVALID_INPUT)
    ...
    if target == "markdown":
        ...
        raise attach_error_code(ValueError("target_format must be markdown or json"), ErrorCode.UNSUPPORTED_TYPE)
